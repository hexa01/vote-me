        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdminVerifications_AspNetUsers_AdminUserId",
                        column: x => x.AdminUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdminVerifications_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Flags = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Metadata = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProcessedMediaIds = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminVerifications_AdminUserId",
                table: "AdminVerifications",
                column: "AdminUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AdminVerifications_ReportId",
                table: "AdminVerifications",
                column: "ReportId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AdminVerifications_Status",
                table: "AdminVerifications",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_AdminVerifications_VerifiedAt",
                table: "AdminVerifications",
                column: "VerifiedAt");
